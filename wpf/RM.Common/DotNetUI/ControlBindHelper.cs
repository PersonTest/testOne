...
namespace RM.Common.DotNetUI
{
    public class ControlBindHelper
    {
        ...
        /// 绑定repeater值
        /// </summary>
        /// <param name="list">IList非泛型对象</param>
        /// <param name="repeater"></param>
        ...
        /// </summary>
        /// <param name="dt">datatable</param>
        /// <param name="dropdownlists">下拉控件对象</param>
        /// <param name="_Name">name</param>
        /// <param name="_ID">value</param>
        /// <param name="_Memo">默认显示</param>
        ...
        /// 绑定下拉菜单
        /// </summary>
        /// <param name="list">非泛型</param>
        /// <param name="dropdownlists">控件对象</param>
        /// <param name="_Name">name</param>
        /// <param name="_ID">value</param>
        /// <param name="_Memo">默认显示</param>
        ...
        /// <param name="dropdownlists">下拉菜单ID</param>
        /// <param name="_Name">name</param>
        /// <param name="_ID">value</param>
        /// <param name="_Memo">默认显示</param>
